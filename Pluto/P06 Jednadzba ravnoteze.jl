...
using SymPyPythonCall, LinearAlgebra, Plots
...
integrate(g(x)*cos(n*x),(x,0,PI))/integrate(cos(n*x)^2,(x,0,PI))/sinh(n*PI)
...
manifest_format = "2.0"
project_hash = "5dbdb6a90767097cea6a167b14c1e98269d1d961"
